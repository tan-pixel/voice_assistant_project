...
if __name__ == "__main__":
    ...
    ww_model.fit(X_train_ww, y_train_ww, epochs=50, batch_size=4, validation_split=0.2, verbose=1)
    ...
    uv_model.fit(X_train_uv, y_train_uv, epochs=50, batch_size=4, validation_split=0.2, class_weight=class_weight, verbose=1)
    ...
    print("\nAll audio models trained and saved successfully!")